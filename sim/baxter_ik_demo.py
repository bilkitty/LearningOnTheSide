...
# not that if includeFixed = False, then no limits are set
# also, not sure what the range settings mean when they are set...
...
if __name__ == "__main__":
    ...
    lowerLimits, upperLimits, jointRanges, restPoses = getJointRanges(baxterId, includeFixed=True)
    ...
    for _ in range(maxIters):
      ...
      # Compute new target position via some out of the box learning algo
